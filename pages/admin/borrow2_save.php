<?php
    ...
    if($num == 0){
        echo "<script>alert('Please borrow device before press apply button');window.location.href='index.php?page=borrow2';</script>";
    }else if($num != 0){
        $sql2 = "INSERT INTO borrow VALUES('$br','$userid','$date','$purid','$jobcard','$staff')";
